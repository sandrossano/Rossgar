...
public class Orari_Cattedrale extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.include_cattedrale_orari).setVisibility(View.VISIBLE);
        findViewById(R.id.include_cripta).setVisibility(View.GONE);
