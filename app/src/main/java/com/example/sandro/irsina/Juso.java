...
public class Juso extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.include_juso).setVisibility(View.VISIBLE);
    ...
    private void init() {
        ...
        viewPager = (ViewPager) findViewById(R.id.pager_juso);
        viewPager.setAdapter(new SlideAdapter(Juso.this, XMENArray));
        CircleIndicator indicator = (CircleIndicator) findViewById(R.id.indicator_juso);
    ...
    public void cambioLingua() {
        ...
        if (current.getLanguage().equals("it")) {
            ...
            Intent refresh = new Intent(this, Juso.class);
            refresh.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
            startActivity(refresh);
            finish();
            return;
