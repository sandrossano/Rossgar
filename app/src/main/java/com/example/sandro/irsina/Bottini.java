...
public class Bottini extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.include_bottini).setVisibility(View.VISIBLE);
    ...
    private void init() {
        ...
        viewPager = (ViewPager) findViewById(R.id.pager_bottini);
        viewPager.setAdapter(new SlideAdapter(Bottini.this, XMENArray));
        CircleIndicator indicator = (CircleIndicator) findViewById(R.id.indicator_bottini);
