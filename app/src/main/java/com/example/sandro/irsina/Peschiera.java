...
public class Peschiera extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.include_peschiera).setVisibility(View.VISIBLE);
    ...
    private void init() {
        ...
        viewPager = (ViewPager) findViewById(R.id.pager_peschiera);
        viewPager.setAdapter(new SlideAdapter(Peschiera.this, XMENArray));
        CircleIndicator indicator = (CircleIndicator) findViewById(R.id.indicator_peschiera);
    ...
    public void cambioLingua() {
        ...
        if (current.getLanguage().equals("it")) {
            ...
            Intent refresh = new Intent(this, Peschiera.class);
    ...
    public void maps(View view){
        ...
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("geo:40.733485, 16.240399?q=40.733485, 16.240399(Peschiera)"));
