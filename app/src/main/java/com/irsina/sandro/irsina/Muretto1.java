...
public class Muretto1 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.include_muretto).setVisibility(View.VISIBLE);
    ...
    private void init() {
        ...
        viewPager = (ViewPager) findViewById(R.id.pager_muretto);
        viewPager.setAdapter(new SlideAdapter(Muretto1.this, XMENArray));
        CircleIndicator indicator = (CircleIndicator) findViewById(R.id.indicator_muretto);
    ...
    public void cambioLingua() {
        ...
        if(current.getLanguage().equals("it")) {
            ...
            Intent refresh = new Intent(this, Muretto1.class);
