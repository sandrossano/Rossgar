...
import static com.irsina.sandro.irsina.MainActivity.height_device;
import static com.irsina.sandro.irsina.MainActivity.swipeTimer;
...
*/
        ...
        final Runnable Update = new Runnable() {
            public void run() {
                if (viewPager2.getCurrentItem()+1 == XMEN2.length) {
